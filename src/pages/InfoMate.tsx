...
export default function InfoMate() {
    ...
    const filtered = resources.filter(
        (r) => r.title.toLowerCase().includes(searchTerm.toLowerCase()) || r.memo.toLowerCase().includes(searchTerm.toLowerCase())
    );
            ...
            <div className="max-w-6xl mx-auto">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        ...
                        <p className="text-white/40 text-lg mb-2">등록된 리소스가 없습니다</p>
                        <p className="text-white/25 text-sm">위 버튼을 눌러 새 리소스를 추가해 보세요</p>
                    </div>
                ) : (
                            ...
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button onClick={() => openEditModal(res)} className="btn-ghost !p-2">
                                            <Edit3 className="w-4 h-4" />
                                        </button>
                                        <button onClick={() => handleDelete(res.id)} className="btn-ghost !p-2 hover:!text-red-400">
                ...
                {modalOpen && (
                    <div className="modal-overlay" onClick={() => setModalOpen(false)}>
                        <motion.div
                            ...
                            className="w-full max-w-lg mx-4 glass-strong rounded-2xl"
                        ...
                        >
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-white/70 mb-1.5">링크</label>
                                    <input
                                        type="url"
                                        placeholder="https://..."
                                        value={formLink}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-white/70 mb-1.5">메모</label>
                                    <textarea
                                        rows={3}
