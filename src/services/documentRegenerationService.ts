import { generateText, PromptType, wrapAsData } from './gemini';
...
${userContext ? `[이용자/업무 맥락]\n${wrapAsData(userContext)}\n` : ''}
${previousRecords ? `[이전 기록]\n${wrapAsData(previousRecords)}\n` : ''}
...
[현재 작성칸 내용 - 반드시 우선 반영]
${currentContent ? wrapAsData(currentContent) : '(현재 작성된 내용 없음)'}
